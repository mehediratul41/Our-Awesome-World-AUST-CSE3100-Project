    ...
    <div class="container form-container">
        ...
        if (!empty($_POST)) {
            ...
            if ($userExists == 0 AND $gmailExists == 0) {
                ...
                ?><p class="text-black" style="color: blue;">Username and Gmail Exists</p><?php
            }

            else if($userExists == 1){
                ?><p class="text-black" style="color: blue;">Username Exists</p><?php
            }

            else if($gmailExists == 1){
                ?><p class="text-black" style="color: blue;">Gmail Exists</p><?php
            }
        }
        ?>
